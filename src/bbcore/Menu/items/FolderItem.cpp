...
void FolderItem::Paint(HDC hDC)
{
    ...
    if (gMenuInfo.nBulletPosition == FOLDER_RIGHT) {
        d = gMenuInfo.nItemRightIndent + mStyle.MenuHilite.borderWidth;
        rc.left = (rc.right = m_nLeft + m_nWidth) - d + 1;
    } else {
        d = gMenuInfo.nItemLeftIndent + mStyle.MenuHilite.borderWidth;
