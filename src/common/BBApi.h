...
// options for MenuItemOption function
...
// flags for SetTaskLocation function
...
extern "C" {
    ...
    API_EXPORT void WriteValue(const char* path, const char* szKey, const char* value);
    ...
    API_EXPORT const char* Tokenize(const char* source, char* target, const char* delimiters);
    ...
    API_EXPORT int BBTokenize( const char* source, char** targets, unsigned numTokens, char* remaining);
